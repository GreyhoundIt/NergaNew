    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="inner-content col-md-12">
               ...
               <h3><a href="{{ url ('info/2017-Rabbits-INDIVIDUAL-Result.pdf') }}" target="_blank">Indivdual Results</a> </h3></br>
               <h3> <a href="{{ url ('info/2017-Rabbits-Finals-Day-Team-Result.pdf') }}" target="_blank">Team Results</a></h3></br>
                <h3><a href="{{ url ('info/2017-Rabbits-Finals Day-Team-Players-Result.pdf') }}" target="_blank">Team PlayerResults</a></h3></br>
