...
class UserTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('users')->insert([
           ...
           ['club_id' => '4','isAdmin' => '0' ,'name' => 'Richmond', 'username' => 'Richmond', 'password' => bcrypt('Richmond2017'), 'created_at' => new DateTime, 'updated_at' => new DateTime ],
           ...
           ['club_id' => '7','isAdmin' => '0' ,'name' => 'Romanby', 'username' => 'Romanby', 'password' => bcrypt('Romanby2017'), 'created_at' => new DateTime, 'updated_at' => new DateTime ],
