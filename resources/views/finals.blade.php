    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="inner-content col-md-12">
               ...
               <h3> <a href="{{ url ('info/FinalsDay2018IntersDraftStartSheet.pdf') }}" target="_blank">The draft start sheet for the Inter Finals Day on 6/10/18</a></h3>
                ...
                <p><b>The Final start sheet will be available 5 days before the event.</b></p>
                </div>
