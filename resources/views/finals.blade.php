    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="inner-content col-md-12">
                ...
                <a href="{{ url ('info/2017-Rabbits-INDIVIDUAL-Result.pdf') }}" target="_blank">Indivdual Results</a> </br>
                <a href="{{ url ('info/2017-Rabbits-Finals-Day-Team-Result.pdf') }}" target="_blank">Team Results</a></br>

                <a href="{{ url ('https://www.dropbox.com/sh/2uh11bo6s2u3kgq/AACANyRtXA7M6DLuaLDv1vy5a?dl=0') }}" target="_blank">Photos from the day</a></br>
